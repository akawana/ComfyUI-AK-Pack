...
class AKProjectSettingsOut:
    ...
    def run(self, ak_project_settings_json):
        ...
        try:
            ...
            if fn:
                image_filepath = _find_first_subfolder_abs_path_by_filename(fn) or ""
        except Exception:
            image_filepath = ""
