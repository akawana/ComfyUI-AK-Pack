...
from .nodes.BypassOnBoolean import NODE_CLASS_MAPPINGS as BYP_MAPPINGS
from .nodes.BypassOnBoolean import NODE_DISPLAY_NAME_MAPPINGS as BYP_DISPLAY

from .nodes.MuteOnBoolean import NODE_CLASS_MAPPINGS as MT_MAPPINGS
from .nodes.MuteOnBoolean import NODE_DISPLAY_NAME_MAPPINGS as MT_DISPLAY
